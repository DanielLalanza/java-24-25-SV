...
public class Main {
    private static Connection conn;     // CONEXIÓN
    private static Statement st;        // QUERY (CONSULTAS SQL)
...
// 📌 Lista donde guardaremos las películas con sus géneros
        ...
        try {
            ...
            ResultSet rs = st.executeQuery(query);  // COMO UN ARRAYLIST QUE VUELVE DE LA BASE DE DATOS;
                                                    // HABRÁ QUE TRANSFORMARLO AL ARRAYLIST DE OBJETOS;
